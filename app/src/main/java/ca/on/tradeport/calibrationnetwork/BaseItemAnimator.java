...
/**
 * Created by webmaster on 16-06-15.
 */
public abstract class BaseItemAnimator extends SimpleItemAnimator {

    private static final boolean DEBUG = false;

    private ArrayList<CalDueAdapter.MyViewHolder> mPendingRemovals = new ArrayList<>();
    private ArrayList<CalDueAdapter.MyViewHolder> mPendingAdditions = new ArrayList<>();
    private ArrayList<MoveInfo> mPendingMoves = new ArrayList<>();
    private ArrayList<ChangeInfo> mPendingChanges = new ArrayList<>();

    private ArrayList<ArrayList<CalDueAdapter.MyViewHolder>> mAdditionsList = new ArrayList<>();
    private ArrayList<ArrayList<MoveInfo>> mMovesList = new ArrayList<>();
    private ArrayList<ArrayList<ChangeInfo>> mChangesList = new ArrayList<>();

    protected ArrayList<CalDueAdapter.MyViewHolder> mAddAnimations = new ArrayList<>();
    private ArrayList<CalDueAdapter.MyViewHolder> mMoveAnimations = new ArrayList<>();
    protected ArrayList<CalDueAdapter.MyViewHolder> mRemoveAnimations = new ArrayList<>();
    private ArrayList<CalDueAdapter.MyViewHolder> mChangeAnimations = new ArrayList<>();

    protected Interpolator mInterpolator = new LinearInterpolator();

    private static class MoveInfo {

        public CalDueAdapter.MyViewHolder holder;
        public int fromX, fromY, toX, toY;

        private MoveInfo(CalDueAdapter.MyViewHolder holder, int fromX, int fromY, int toX, int toY) {
            this.holder = holder;
            this.fromX = fromX;
            this.fromY = fromY;
            this.toX = toX;
    ...
    private static class ChangeInfo {
        ...
        public CalDueAdapter.MyViewHolder oldHolder, newHolder;
        public int fromX, fromY, toX, toY;

        private ChangeInfo(CalDueAdapter.MyViewHolder oldHolder, CalDueAdapter.MyViewHolder newHolder) {
            this.oldHolder = oldHolder;
            this.newHolder = newHolder;
        }

        private ChangeInfo(CalDueAdapter.MyViewHolder oldHolder, ViewHolder newHolder, int fromX, int fromY, int toX,
                           int toY) {
    ...
    @Override public void runPendingAnimations() {
        ...
        // First, remove stuff
        for (CalDueAdapter.MyViewHolder holder : mPendingRemovals) {
        ...
        // Next, add stuff
        if (additionsPending) {
            final ArrayList<CalDueAdapter.MyViewHolder> additions = new ArrayList<CalDueAdapter.MyViewHolder>();
            additions.addAll(mPendingAdditions);
            mAdditionsList.add(additions);
            mPendingAdditions.clear();
            Runnable adder = new Runnable() {
                public void run() {
                    for (CalDueAdapter.MyViewHolder holder : additions) {
                        doAnimateAdd(holder);
                    }
                    additions.clear();
    ...
    @Override
    public boolean animateChange(CalDueAdapter.MyViewHolder oldHolder, ViewHolder newHolder, int fromX, int fromY,
                                 int toX, int toY) {
    ...
    @Override public void endAnimation(CalDueAdapter.MyViewHolder item) {
        ...
        for (int i = mAdditionsList.size() - 1; i >= 0; i--) {
            ArrayList<CalDueAdapter.MyViewHolder> additions = mAdditionsList.get(i);
    ...
    void cancelAll(List<CalDueAdapter.MyViewHolder> viewHolders) {
